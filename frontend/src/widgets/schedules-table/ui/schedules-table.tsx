...
import { Schedule, useGetSchedules } from '@/entities/schedule';
import { CreateScheduleButton } from '@/features/create-schedule';
import { DeleteScheduleDropdownItem } from '@/features/delete-schedule';
import { UpdateScheduleDrawer } from '@/features/update-schedule';
...
function BasicTableRow({ row }: { row: Row<Schedule> }) {
  return (
...
function TableCellViewer({ item }: { item: Schedule }) {
